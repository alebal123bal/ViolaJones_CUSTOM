...
IMAGE_PATH = "viola_jones/inference/test_image/some_people.jpg"
# IMAGE_PATH = "viola_jones/inference/test_image/one_person.jpg"
...
def window_slide(image_path: str, classifier_path: str):
    ...
    for scale in [
        ...
        for y in range(0, test_image.shape[0] - int(22 * scale), 10):
            for x in range(0, test_image.shape[1] - int(22 * scale), 10):
    ...
    for x, y, size in detected_faces:
        print(f"Detected face at ({x}, {y}) with size {size}.")
